...
export function CoverageStep({ analysis, mockMode, onBack, onStartQuiz }: { analysis: Analysis; mockMode: boolean; onBack: () => void; onStartQuiz: () => void }) {
  ...
  return <section className="panel" aria-labelledby="coverage-title">
    ...
    <div className="panel-body">
      ...
      <div className="actions"><button className="button button-secondary" type="button" onClick={onBack}>Back to input</button><button className="button button-primary" type="button" onClick={onStartQuiz}>Start diagnostic quiz</button></div>
    </div>
  </section>;
}
